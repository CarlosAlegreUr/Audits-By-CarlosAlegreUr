...
# General Stats 📈
 ...
 | ---------------------- | ------------------ | ------------------------------ |
 | **_`14 (1 judging)`_** | **_`$5412.52$`_**  | **_`566.63h`_**                |

| _High Risk_ 🏅   | _Medium Risk_ 🥈 | _Low Risk_ 🥉 | _QAs_ 🌐 | _Gas Optimizaition_ ⛽ |
| --------------- | --------------- | ------------ | ------- | --------------------- |
| 3 (+2? judging) | 7 (+2? judging) | 18           | 15      | 2                     |
...
| -------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------- | ---------------------------------------------------------------------- | ---------------------------------- |
| 🧑‍⚖️🧑‍🤝‍🧑           | ***Size***: loans order book                                                                         | **`$0/0/0/0/0/0`**               | [go to report](./reports/2024-05-midas/)                               | 10/June/2024 - 2/July/2024         |
